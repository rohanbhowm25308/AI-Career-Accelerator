...
export function getInterviewReplay(sessionId) {
    return getJSON(`/interview/replay/${sessionId}`);
}
...
export function suiteHiringSimulation(payload) {
    return postJSON("/suite/hiring-simulation", payload);
}

export function suiteTimeMachine(payload) {
    return postJSON("/suite/time-machine", payload);
}

export function suiteStressTest(payload) {
    return postJSON("/suite/stress-test", payload);
}

export async function suiteResumeBattle(fileA, fileB, labelA, labelB) {
    const formData = new FormData();
    formData.append("resume_a", fileA);
    formData.append("resume_b", fileB);
    if (labelA) formData.append("label_a", labelA);
    if (labelB) formData.append("label_b", labelB);
    const res = await fetchWithTimeout(BASE_URL + "/suite/resume-battle", { method: "POST", body: formData });
    checkResponse(res);
    return res.json();
}

export function suiteHiddenTalent(payload) {
    return postJSON("/suite/hidden-talent", payload);
}

export function suiteScorecard(payload) {
    return postJSON("/suite/scorecard", payload);
}

export function suiteRecruiterPsychology(payload) {
    return postJSON("/suite/recruiter-psychology", payload);
}

export function suiteResumeEvolution(payload) {
    return postJSON("/suite/resume-evolution", payload);
}

export function suiteOpportunityRadar(payload) {
    return postJSON("/suite/opportunity-radar", payload);
}

export function suiteHackathonPartner(payload) {
    return postJSON("/suite/hackathon-partner", payload);
}

export function suiteDreamCompany(payload) {
    return postJSON("/suite/dream-company", payload);
}

export function suiteDecisionExplanation(payload) {
    return postJSON("/suite/decision-explanation", payload);
}

export function suiteCareerStory(payload) {
    return postJSON("/suite/career-story", payload);
}

export function suiteDigitalRecruiter(payload) {
    return postJSON("/suite/digital-recruiter", payload);
}
